...
// -----------------------------------------------------------------
#define SCHED_ALPHA      1    // aging increment per wait cycle     (REQ-SCH-6; range 0-5,   REQ-SCH-7)
#define SCHED_BETA       2    // CPU penalty decrement per run cycle (REQ-SCH-6; range 0-10,  REQ-SCH-7)
...
// -----------------------------------------------------------------
#define SCHED_TCPU_MAX  10    // CPU-bound tick threshold per window (REQ-SCH-6; range 1-100,  REQ-SCH-7)
